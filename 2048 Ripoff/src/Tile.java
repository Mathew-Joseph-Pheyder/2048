...
public class Tile extends Actor {
    ...
    public void act() {
        ...
        if (Mayflower.isKeyPressed(Keyboard.KEY_UP) && (!Mayflower.isKeyDown(Keyboard.KEY_DOWN) && !Mayflower.isKeyDown(Keyboard.KEY_LEFT) && !Mayflower.isKeyDown(Keyboard.KEY_RIGHT))) {
            ...
            if (Mayflower.isKeyPressed(Keyboard.KEY_LEFT) && (!Mayflower.isKeyDown(Keyboard.KEY_UP) && !Mayflower.isKeyDown(Keyboard.KEY_DOWN) && !Mayflower.isKeyDown(Keyboard.KEY_RIGHT))) {
                while ((getX() > 65)) {
                    setLocation(getX() - 65, getY());
                }

            }
            if (Mayflower.isKeyPressed(Keyboard.KEY_RIGHT)&& (!Mayflower.isKeyDown(Keyboard.KEY_UP) && !Mayflower.isKeyDown(Keyboard.KEY_DOWN) && !Mayflower.isKeyDown(Keyboard.KEY_LEFT))) {
                while ((getX() < 132)) {
